$(function() {
	...
	function c() {
		var o = $(this).attr("href"), m = $(this).data("index"), l = $.trim($(
				this).text()), k = true , tabname=$(this).attr("tabname");
		l=tabname==undefined ||$.trim(tabname).length == 0?l:tabname;
		...
		if (k) {
			...
			var n = '<iframe class="J_iframe" name="iframe' + m
					...
					+ '" seamless onload="FRAME_ONLOAD()"></iframe>';
	...
	$.fn.contabs={};
	$.fn.contabs.methods={"clickItem":c};
