...
<head>
    ...
    <link href="<spring:url value="/resources/css/shop.css"/>" type="text/css" rel="stylesheet"/>
    <link href="<spring:url value="/resources/skin/default/skin.css"/>" rel="stylesheet" type="text/css" id="skin"/>
    <link href="<spring:url value="/resources/css/Sellerber.css"/>" type="text/css" rel="stylesheet"/>
    <link href="<spring:url value="/resources/css/bkg_ui.css"/>" type="text/css" rel="stylesheet"/>
    <link href="<spring:url value="/resources/font/css/font-awesome.min.css"/>" rel="stylesheet" type="text/css"/>
            ...
            <div id="login-box" class="login-box widget-box no-border visible">
                <div class="login-main">
                    <div class="clearfix">
                        ...
                        <form id="loginForm" class="" method="post" action="/j_spring_security_check"
                            ...
                            <fieldset>
                                <ul>
                                    <li class="frame_style form_error"><label class="user_icon"></label>
                                        <input name="username" type="text" data-name="用户名" id="username"/><i>用户名</i>
                                    </li>
                                    <li class="frame_style form_error"><label class="password_icon"></label>
                                        <input name="password" type="password" data-name="密码" id="userpwd"/><i>密码</i>
                                    </li>
                                    <li class="frame_style form_error"><label class="Codes_icon"></label>
                                        <input name="" type="text" data-name="验证码" id="Codes_text"/><i>验证码</i>
                                        <div class="Codes_region"><img src="/resources/images/yanzhengma.png" width="100%" height="38px"></div>
                                    </li>
                                </ul>
                                <div class="space"></div>
                                <div class="clearfix">
                                    <label class="inline">
                                        <input type="checkbox" name="_spring_security_remember_me" class="ace">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("input[type='name'],input").focus(function () {
            var $el = $(this);
            var $parent = $el.parent();
