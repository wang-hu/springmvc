...
if(_8f.text){
$("<span class=\"l-btn-name\"></span>").html(_8f.text).appendTo(_90);
}else{
$("<span class=\"l-btn-name l-btn-empty\">&nbsp;</span>").appendTo(_90);
}
if(_8f.iconCls){
...
$(_1dc).html("<div class=\"progressbar-name\"></div><div class=\"progressbar-value\"><div class=\"progressbar-name\"></div></div>");
...
bar.find("div.progressbar-name,div.progressbar-value").css({height:bar.height()+"px",lineHeight:bar.height()+"px"});
};
...
opts=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon messager-question\"></div>"+"<div>"+opts.msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"name\"/></div>",buttons:[{text:$.messager.defaults.ok,onClick:function(){
win.window("close");
...
$(this).find(".menu-name").css({height:(opts.itemHeight-2)+"px",lineHeight:(opts.itemHeight-2)+"px"});
});
...
$("<div class=\"menu-name\"></div>").html(_407.text).appendTo(item);
}
if(_407.iconCls){
...
return jq.each(function(){
$(_417.target).children("div.menu-name").html(_417.text);
});
...
var t=$(_419);
var item={target:_419,id:t.attr("id"),text:$.trim(t.children("div.menu-name").html()),disabled:t.hasClass("menu-item-disabled"),name:_419.itemName,href:_419.itemHref,onclick:_419.onclick};
...
(function($){
function init(_43d){
$(_43d).addClass("validatebox-name");
};
function _43e(_43f){
...
if(!rule["validator"].call(_459,_461,_463,rule)){   //modify by xl 为动态消息提供接口
...
var span=$("<span class=\"textbox\">"+"<input class=\"textbox-name\" autocomplete=\"off\">"+"<input type=\"hidden\" class=\"textbox-value\">"+"</span>").insertAfter(_476);
...
$("<input type=\""+opts.type+"\" class=\"textbox-name\" autocomplete=\"off\">").prependTo(tb);
}
...
var _49c=_49b.textbox.find(".textbox-name");
...
$(_4d1).find(".textbox-name:focus").blur();
var _4d4="easyui_frame_"+(new Date().getTime());
//var _4d5=$("<iframe id="+_4d4+" name="+_4d4+"></iframe>").appendTo("body"); // modify by xl fix bug under 360 fast
...
_4d5.appendTo("body"); // modify by xl fix bug under 360 fast
_4d5.bind("load",cb);
_4d6(_4d3);
function _4d6(_4d7){
var form=$(_4d1);
...
$(_4f5).find(".validatebox-name:not(:disabled)").validatebox(_4f6?"disableValidation":"enableValidation");
};
...
function init(_515){
$(_515).addClass("calendar").html("<div class=\"calendar-header\">"+"<div class=\"calendar-nav calendar-prevmonth\"></div>"+"<div class=\"calendar-nav calendar-nextmonth\"></div>"+"<div class=\"calendar-nav calendar-prevyear\"></div>"+"<div class=\"calendar-nav calendar-nextyear\"></div>"+"<div class=\"calendar-title\">"+"<span class=\"calendar-name\"></span>"+"</div>"+"</div>"+"<div class=\"calendar-body\">"+"<div class=\"calendar-menu\">"+"<div class=\"calendar-menu-year-inner\">"+"<span class=\"calendar-nav calendar-menu-prev\"></span>"+"<span><input class=\"calendar-menu-year\" type=\"name\"></input></span>"+"<span class=\"calendar-nav calendar-menu-next\"></span>"+"</div>"+"<div class=\"calendar-menu-month-inner\">"+"</div>"+"</div>"+"</div>");
...
var _6f5=$("<input type=\"name\" class=\"datagrid-editable-input\">").appendTo(_6f3);
...
var _70e=$("<input type=\"name\" class=\"datagrid-editable-input\">").appendTo(_70c);
...
_7e3.push("<td style=\"border:0;name-align:center;width:25px\"><span class=\"datagrid-row-expander datagrid-row-collapse\" style=\"display:inline-block;width:16px;height:16px;cursor:pointer\">&nbsp;</span></td>");
}
...
var queryParams=opts.queryParams;opts.queryParams=$.extend({},queryParams,{initValue:opts.value});//modify by xl for initValue render
...
opts.queryParams=queryParams;grid.datagrid("options").queryParams=queryParams; // modify  by xl
