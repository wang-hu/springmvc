...
KindEditor.lang({
	...
	copy : 'Copy(Ctrl+C)',
	paste : 'Paste(Ctrl+V)',
	plainpaste : 'Paste as plain name',
	...
	'plainpaste.comment' : 'Use keyboard shortcut(Ctrl+V) to paste the name into the window.',
	'wordpaste.comment' : 'Use keyboard shortcut(Ctrl+V) to paste the name into the window.',
