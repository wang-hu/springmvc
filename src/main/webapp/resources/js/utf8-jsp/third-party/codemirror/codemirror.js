...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        wrapper.innerHTML =
            '<div style="overflow: hidden; position: relative; width: 3px; height: 0px;">' + // Wraps and hides input textarea
                ...
                '<div style="position: relative">' + // Set to the height of the name, causes scrolling
                '<div style="position: relative">' + // Moved around its parent to cover visible view
                '<div class="CodeMirror-gutter"><div class="CodeMirror-gutter-name"></div></div>' +
                // Provides positioning relative to (visible) name origin
        ...
        function measureLine(line, ch) {
            var extra = "";
            // Include extra name at the end to make sure the measured line is wrapped in the right way.
            if (options.lineWrapping) {
    ...
    CodeMirror.getMode = function(options, spec) {
        ...
        if (!mfactory) {
            if (window.console) console.warn("No mode " + mname + " found, falling back to plain name.");
            return CodeMirror.getMode(options, "name/plain");
        }
    ...
    Line.prototype = {
        ...
        // array, which contains alternating fragments of name and CSS
        // classes.
    ...
    CodeMirror.defineMIME("name/plain", "null");
...
CodeMirror.defineMIME("name/html", {name: "xml", htmlMode: true});
...
CodeMirror.defineMIME("name/javascript", "javascript");
...
CodeMirror.defineMIME("name/css", "css");
...
CodeMirror.defineMIME("name/html", "htmlmixed");
